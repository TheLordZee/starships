...
class Destiny extends ShipObject{
    constructor(scene, x, y, isPlayer){
        super(scene, x, y, 'destiny', 50, 250, 30, 15, 5, 'light', isPlayer)
    }
}

class Divinity extends ShipObject{
    constructor(scene, x, y, isPlayer){
        super(scene, x, y, 'divinity', 100, 250, 30, 20, 15, 'light', isPlayer)
    }
}

class Endmyion extends ShipObject{
    constructor(scene, x, y, isPlayer){
        super(scene, x, y, 'endymion', 200, 200, 30, 15, 20, 'light', isPlayer)
    }
}

class Lux extends ShipObject{
    constructor(scene, x, y, isPlayer){
        super(scene, x, y, 'lux', 500, 150, 30, 15, 50, 'light', isPlayer)
    }
}
